<template>
    <el-dialog
        v-model="isModalOn"
        title="You are not registered, setup your profile!"
        width="600"
        ...
        <div class="grid grid-cols-12 gap-3">
            <div class="col-span-6">
                <div class="border-2px boder-[#409eff]">
                    <img :src="avatarLink ? avatarLink : 'https://img.freepik.com/premium-vector/man-avatar-profile-picture-vector-illustration_268834-541.jpg?w=360'" class="w-full aspect-square border-[2px] border-[#409eff]" />
                </div>
            </div>
            <div class="flex flex-col justify-between col-span-6">
                ...
                <div>
                    <el-button class="w-full" type="primary" :loading-icon="Eleme" :loading="loading" @click="onSetProfoile">Confirm</el-button>
                </div>
            </div>
        </div>
    </el-dialog>
